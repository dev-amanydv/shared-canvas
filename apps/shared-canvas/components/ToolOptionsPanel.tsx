    ...
    >
      ...
      {toolOptions.backgroundColor !== "transparent" && (
        <div>
          ...
          <div className="flex items-center gap-[6px]">
            <OptionButton
              active={toolOptions.fillStyle === "hachure"}
            ...
            <OptionButton
              active={toolOptions.fillStyle === "cross-hatch"}
            ...
            <OptionButton
              active={toolOptions.fillStyle === "solid"}
